...
@DisplayName("Hexagonal architecture — ArchUnit guards — order-service")
class HexagonalArchitectureTest {
    ...
    static void importClasses() {
        classes = new ClassFileImporter().importPackages("com.aubin.order");
    }
    ...
    void no_api_package_at_root() {
        noClasses()
                .should().resideInAPackage("com.aubin.order.api..")
